...
export function ProfileScreen({ navigation, route }) {
  ...
  const pressViewStyle = useAnimatedStyle(() => {
    ...
    return {
      ...
      width: width - 60, backgroundColor: "orange",
      height: 160,
  ...
  return (
    ...
    */}
        ...
        {/* <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-around" }}>
          {item.name === userName && <IconBtn bgColor={"#fafafa"} bgColor2={bgColor2} iconName="image-outline" onPress={function () {
            inputRef.current.blur()
          ...
          {item.name === userName && <IconBtn bgColor={"#fafafa"} bgColor2={bgColor2} iconName="chatbox-ellipses-outline" onPress={function () {
            inputRef.current.blur()
            btnScale.value = btnScale.value === 0 ? 1 : 0


          }} />}

          {item.name === userName && <IconBtn bgColor={"#fafafa"} bgColor2={bgColor2} iconName="camera-outline" onPress={function () {
            inputRef.current.blur()
