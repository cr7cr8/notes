...
import { StyleSheet, Button, Dimensions, FlatList, TouchableOpacity, TouchableNativeFeedback, } from 'react-native';
...
import { PanGestureHandler, ScrollView as ScrollV } from 'react-native-gesture-handler';
    ...
    <FlatList
      ...
      renderItem={function ({ item, index }) {
        ...
        return (
          <View
            style={{
              width, height: "100%", backgroundColor: "pink"
            }}
