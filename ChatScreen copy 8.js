...
export function ChatScreen({ navigation, route, ...props }) {
  ...
  const { peopleList, setPeopleList, messages, setMessageList } = useContext(Context)
          ...
          return (
            <Send {...props}
              ...
              <View style={
                ...
                <Icon
                  onPress={function () { panelHeight.value = 0; pickImage(setMessageList) }}
                  name="image-outline"
                  type='ionicon'
                  color='#517fa4'
                  size={inputText ? 0 : 50}
                ...
                <Icon
                  onPress={function () { panelHeight.value = 0; takePhoto(setMessageList) }}
                  name="camera-outline"
                  type='ionicon'
                  color='#517fa4'
                  size={inputText ? 0 : 50}
...
async function pickImage(setMessageList) {
...
async function takePhoto(setMessageList) {
